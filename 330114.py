...
def enviar_alerta(velocidad):
    try:
        subject = f"ALERTA: Velocidad de viento SUPERADA - San Pablo DASA (330114) {velocidad} kt"
        body = (f"ALERTA:\n\nLa velocidad del viento alcanzó {velocidad} kt, "
                f"superando el límite de {LIMITE_VELOCIDAD} kt en estación 330114 (San Pablo DASA).")
        msg = MIMEMultipart()
...
if __name__ == "__main__":
    ...
    if velocidad is not None:
        ...
        append_csv("330114", ts, velocidad)
